...
4. **Генерация PDF**:
   ...
   - Имя файла: `<id_клиента>_<недель>_weeks_<дата>_<номер>.pdf` (например, `123_4_weeks_13112025_0001.pdf`)
   - Поддержка шаблонов футтеров с плейсхолдерами (настраиваются в разделе «Шаблоны программ»)
   - Отправляется клиенту в Telegram/Email
...
5. ✅ Осмысленные имена PDF-файлов: `<id_клиента>_<недель>_weeks_<дата>_<номер>.pdf`
6. ✅ Шаблоны футтеров для PDF с плейсхолдерами
7. ✅ Очистка старых программ (архивация отправленных, удаление неиспользуемых)
8. ✅ Автоматическая очистка неиспользуемых файлов из `uploads/` при запуске

### Планируемые улучшения:
1. ⏳ Расширение покрытия программ
2. ⏳ Учет реальных тренировок тренера
3. ⏳ Прогрессия по неделям
4. ⏳ Система замен упражнений
